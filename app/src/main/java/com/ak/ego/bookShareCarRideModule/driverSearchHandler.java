...
public class driverSearchHandler extends Handler {

    public driverSearchHandler(Looper looper)
    {
        super(looper);
    }
    ...
    public void handleMessage(Message msg) {
        ...
        Log.d("HANDLERHANDLEMESSAGE",""+msg.arg1);
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                JsonObjectRequest request_users_in_these_regions = new JsonObjectRequest(Request.Method.GET,AppConfig.get_all_users+"?user_type="+"ServiceProvider",params, new Response.Listener<JSONObject>() {
                    @Override
